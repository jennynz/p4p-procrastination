...
This is basically Github's punchcard, only it unravels the commits over dates as well, and is embellished a little to better illustrate the thoughts and emotions throughout the journey.
...
This word cloud was generated just by following [this handy tutorial](http://www.sthda.com/english/wiki/text-mining-and-word-cloud-fundamentals-in-r-5-simple-steps-you-should-know). Fun times with R!

## Conclusions

 Well, that was pointless yet mildly satisfying! Now that I feel like I've brushed up on R a little, I can leave the realm of weird assignment operators in search of better coding projects.

 _A big thanks to my supervisors Dr Catherine Watson and Dr Richard Clarke, who are truly the best supervisors I can imagine. They were so enthusiastic and patient with me throughout our research journey, despite my time management being, well, as above. I thoroughly enjoyed my project, and will always harbour an interest for voice science and computational linguistics in the future!_